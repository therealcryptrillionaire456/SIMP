...
try:
    # Try new SIMP package paths first
    from ..data_acquisition.web_scraper import SecurityDatasetScraper
    from ..data_acquisition.dataset_processor import SecurityDatasetProcessor
    from ..integrations.brp.sigma_rules import SigmaEngine, LogEvent, DetectionResult
    from ..integrations.brp.ml_pipeline import MLTrainingPipeline
    from ..agents.brp_agent import EnhancedBillRusselAgent, EnhancedThreatEvent
except ImportError:
    try:
        # Fall back to legacy absolute imports
        ...
        # Graceful degradation - components may not be available
        SecurityDatasetScraper = None
        SecurityDatasetProcessor = None
        SigmaEngine = None
        LogEvent = None
